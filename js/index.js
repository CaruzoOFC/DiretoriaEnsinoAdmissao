...
function elaborarOfc()
{
    ...
    if ($("#rgPessoa").val().length != 0 && $("#nomePessoa").val().length != 0 && $("#motivoConvoc").val().length != 0 && $("#respPrisao").val() != "") 
    {
        ...
        $("#assinaturaResp").text($("#respPrisao").val())
        $(".navbar").hide();
        $("#p1").append(`Eu, <b>${$("#cargoPessoa").val().toUpperCase()}</b> da Diretoria de Ensino e Admissão <b>${$("#nomePessoa").val().toUpperCase()}</b> portador(a) do <b>RG</b> de Nº<b>${$("#rgPessoa").val().toUpperCase()}</b> no uso de minhas atribuições, decido por: \nDesligar de suas funções exercidas da Diretoria de Ensino e Admissão o atual <b>${$("#cargoPunido").val().toUpperCase()}</b> <b>${$("#motivoConvoc").val().toUpperCase()}</b>\n portador do RG de Nº <b>${$("#idPunido").val().toUpperCase()}</b> das funções <b>${$("#solicitacaoR").val().toUpperCase()}</b>, \nAgradecemos seus serviços em prol a Diretoria de Ensino e Admissão.`)
        $("#p2").append(' ')
...
function elaborarUp()
{
    ...
    if ($("#rgPessoa").val().length != 0 && $("#nomePessoa").val().length != 0 && $("#motivoConvoc").val().length != 0 && $("#respPrisao").val() != "") 
    {
        ...
        $("#assinaturaResp").text($("#respPrisao").val())
        $(".navbar").hide();
        $("#p1").append(`Eu, <b>${$("#cargoPessoa").val().toUpperCase()}</b> da Diretoria de Ensino e Admissão <b>${$("#nomePessoa").val().toUpperCase()}</b> portador(a) do <b>RG</b> de Nº<b>${$("#rgPessoa").val().toUpperCase()}</b> no uso de minhas atribuições, decido por: \nPromover o Sr.(a) <b>${$("#motivoConvoc").val().toUpperCase()}</b> \n portador do RG de Nº <b>${$("#idPunido").val().toUpperCase()}</b> atual <b>${$("#cargoPunido").val().toUpperCase()}</b>, para funções de <b>${$("#funcaoAtual").val().toUpperCase()}</b>, e responsável por <b>${$("#aulaAplicada").val().toUpperCase()}</b> durante o período na ACADEPOL em consonância com a decisão conjunta da direção acadepol.`)
        $("#p2").append(' ')
        $("#dataAtual").append('Destiny, '+str_data)
        html2canvas(document.getElementById("container"), {
            allowTaint: true,
...
function elaborarAtribuicao()
{
    ...
    if ($("#rgPessoa").val().length != 0 && $("#nomePessoa").val().length != 0 && $("#motivoConvoc").val().length != 0 && $("#respPrisao").val() != "") 
    {
        ...
        $("#assinaturaResp").text($("#respPrisao").val())
        $(".navbar").hide();
        $("#p1").append(`Eu, <b>${$("#cargoPessoa").val().toUpperCase()}</b> da Diretoria de Ensino e Admissão <b>${$("#nomePessoa").val().toUpperCase()}</b> portador(a) do <b>RG</b> de Nº<b>${$("#rgPessoa").val().toUpperCase()}</b> no uso de minhas atribuições, decido por: \nAtribuir o Sr.(a) <b>${$("#motivoConvoc").val().toUpperCase()}</b> \n portador do RG de Nº <b>${$("#idPunido").val().toUpperCase()}</b> atual <b>${$("#cargoPunido").val().toUpperCase()}</b> do Departamento de Polícia do Destiny, para funções de <b>${$("#funcaoAtual").val().toUpperCase()}</b> da Diretoria de Ensino e Admissão, com atribuições de auxiliar e promover as necessidades do setor.`)
        $("#p2").append(' ')
        $("#dataAtual").append('Destiny, '+str_data)
        html2canvas(document.getElementById("container"), {
            allowTaint: true,
...
function elaborarReciclagem()
{
    window.scrollTo(0, 0)
    if ($("#rgPessoa").val().length != 0 && $("#cargoPessoa").val().length != 0 && $("#nomePessoa").val().length != 0 && $("#rgPessoa").val() != "") 
    {
        var str_data = ("0" + dia).slice(-2)+" de "+meses[data.getMonth()]+" de "+ano;
        $("#hideOnPrint").hide()
        $("#btnGerar").hide()
        ...
        $("#assinaturaResp").text($("#respPrisao").val())
        $(".navbar").hide();
        $("#p1").append(`A Diretoria de Ensino e Admissão informa que no dia <b>${$("#cargoPessoa").val().toUpperCase()}</b> o <b>${$("#nomePessoa").val().toUpperCase()}</b> foi aplicado para os seguintes candidatos que desejam fazer parte do quadro de <b>${$("#rgPessoa").val().toUpperCase()}</b> do Departamento de Polícia do Destiny. Sendo assim os Candidatos citados abaixo foram instruídos e capacitados quanto a qualificação e preparo para estar atuando em suas funções dentro do Departamento de Polícia, enquanto estiverem inseridos no DPD após a realização do curso os candidatos devem cumprir e fazer valer todos os procedimentos, atribuições, funções e deveres que foram passados no curso.`)
        $("#p2").append(' ')
...
function elaborarAlvara()
{
    ...
    if ($("#rgPessoa").val().length != 0 && $("#nomePessoa").val().length != 0 && $("#telefonePessoa").val().length != 0 && $("#inscMuni").val().length != 0 && $("#nomeEst").val().length != 0 && $("#atvEst").val().length != 0 && $("#endEst").val().length != 0 && $("#respPrisao").val() != "") 
    {
        ...
        $("#ddsInscE").text('Nº '+$("#inscMuni").val()+'/2023')
